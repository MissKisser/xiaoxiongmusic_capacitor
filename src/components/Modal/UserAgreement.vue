...
<template>
  <div class="user-agreement">
    <n-h3 class="title">软件许可使用协议</n-h3>
    <n-scrollbar class="scrollbar">
      <n-flex class="date" justify="center">
        <n-tag type="warning" round>更新日期：2026 年 1 月 26 日</n-tag>
        <n-tag type="info" round>协议版本：v2.0</n-tag>
      </n-flex>
      <n-alert type="warning" title="重要声明">        
        小熊音乐是一款完全免费的音乐播放软件。二次开发自SPlayer。
        本软件永远不会向用户收取任何费用。如果您是从第三方渠道付费购买本软件，
        您可能遇到了诈骗，请立即停止使用并举报。
      </n-alert>
      <n-p>
        欢迎使用 小熊音乐（以下简称"本软件"）。本软件是一个本地音乐播放软件，可能会调用第三方 API
        来增强其功能。请在使用本软件前仔细阅读本用户协议。本协议是您（以下简称"用户"）与 小熊音乐
        （以下简称"开发者"）之间的法律协议。一旦您下载、安装或使用本软件，即表示您同意接受本协议的所有条款和条件。
      </n-p>
      ...
      <n-ol>
        <n-li>
          本软件及其所有内容（包括但不限于软件、标识、图形、用户界面、脚本和服务名称）均为开发者或其许可方的财产，受知识产权法保护。
        </n-li>
